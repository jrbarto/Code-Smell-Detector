...
public class Runner {
	private final String REVIEW_BODY = "The automated 'Code Smell Detector' tool found issues "
	...
	public Runner(String groovyFile, String owner, String repoName, String user, String password, String comment) {
		this.groovyFile = groovyFile;
		this.owner = owner;
		this.repoName = repoName;
		this.comment = "[Code Smell Detector Automated Comment]\n" + comment;
		this.restClient = new GHRestClient(API_URL, user, password);
	}
	...
	public void executeRepoReview() throws JSONException, IOException {
		ArrayList<GHFile> repoFiles= restClient.getRepoFiles(owner, repoName);

		String lineViolations = "";
		System.out.println("[Action] Checking all files in repository '" + repoName + "'...");
